...
def test_ws_same_host_lan_origin_accepted():
    _clean()
    with TestClient(create_app(host="0.0.0.0"), base_url="http://192.168.1.20:55155") as c:
        headers = {"host": "192.168.1.20:55155", "origin": "http://192.168.1.20:55155"}
...
def test_ws_cross_site_origin_rejected_on_lan_bind():
    _clean()
    with TestClient(create_app(host="0.0.0.0"), base_url="http://192.168.1.20:55155") as c:
        headers = {"host": "192.168.1.20:55155", "origin": "http://evil.example.com"}
